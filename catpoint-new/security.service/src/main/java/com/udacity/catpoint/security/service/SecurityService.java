...
//    private FakeImageService imageService;
    ...
    public void setArmingStatus(ArmingStatus armingStatus) {
        ...
        //added to satisfy requirement no. 10
        if (armingStatus == ArmingStatus.ARMED_HOME || armingStatus == ArmingStatus.ARMED_AWAY) {
            // Deactivate all sensors
            Set<Sensor> sensors_set = new HashSet<>(getSensors());
            sensors_set.forEach(sensor -> {
    ...
    private void handleSensorDeactivated() {
        switch(securityRepository.getAlarmStatus()) {
            ...
            //commented the below line to pass requirement no. 4
//            case ALARM -> setAlarmStatus(AlarmStatus.PENDING_ALARM);
    ...
    public void changeSensorActivationStatus(Sensor sensor, Boolean active) {
        ...
        //updated code to satisfy requirement no. 5
